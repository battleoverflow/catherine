...
Catherine does depend on custom built [modules](https://github.com/hifumisoftware/catherine-modules), which are not required, but recommended to enhance the tools at your disposal.
...
```bash
curl https://raw.githubusercontent.com/hifumisoftware/catherine/main/Catherine_Installer | bash
```
